...
public class VueEnnemie extends Vue {
	...
	// public void changerImage(String s , int x, int y) throws
	// FileNotFoundException {
	// this.fichierPerso = new FileInputStream("src/ressources/ImagePerso/" + s
	// +".png");
	 ...
	 * imgV_perso.setTranslateX(imgV_perso.getTranslateX()+deplacement); } public
	 * void deplacementY (int deplacement) {
	 * imgV_perso.setTranslateY(imgV_perso.getTranslateY()+deplacement); }
	 */
	// public void setImage () throws FileNotFoundException {
	// this.pane.getChildren().clear();// this.fichierPerso = new
	// FileInputStream("src/ressources/NewPiskel(1).png");
	// this.img_perso = new Image(fichierPerso);
	// imgV_perso=new ImageView(img_perso);
	// initPerso();
	// }
