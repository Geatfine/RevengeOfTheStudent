...
public class Homps extends Ennemie{
	...
	private  void ticEnnemie(Hero hero) {
		...
		if(!this.colision.verifieCase(this.position.xProperty().get(), this.position.yProperty().get())) {
			...
			if (!this.colision.verifieCaseDroite(this.position.xProperty().get(), this.position.yProperty().get()) || !colision.verifieCaseGauche(this.position.xProperty().get()-1, this.position.yProperty().get()) )
